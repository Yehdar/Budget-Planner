...
set CLASSPATH=%APP_HOME%\lib\backend.jar;%APP_HOME%\lib\ktor-server-netty-jvm-2.3.0.jar;%APP_HOME%\lib\ktor-server-call-logging-jvm-2.3.0.jar;%APP_HOME%\lib\ktor-server-host-common-jvm-2.3.0.jar;%APP_HOME%\lib\ktor-server-core-jvm-2.3.0.jar;%APP_HOME%\lib\ktor-serialization-jvm-2.3.0.jar;%APP_HOME%\lib\ktor-events-jvm-2.3.0.jar;%APP_HOME%\lib\ktor-http-cio-jvm-2.3.0.jar;%APP_HOME%\lib\ktor-websockets-jvm-2.3.0.jar;%APP_HOME%\lib\ktor-http-jvm-2.3.0.jar;%APP_HOME%\lib\ktor-network-jvm-2.3.0.jar;%APP_HOME%\lib\ktor-utils-jvm-2.3.0.jar;%APP_HOME%\lib\ktor-io-jvm-2.3.0.jar;%APP_HOME%\lib\kotlinx-coroutines-jdk8-1.6.4.jar;%APP_HOME%\lib\kotlinx-coroutines-core-jvm-1.6.4.jar;%APP_HOME%\lib\kotlinx-coroutines-slf4j-1.6.4.jar;%APP_HOME%\lib\kotlin-stdlib-jdk8-1.9.0.jar;%APP_HOME%\lib\logback-classic-1.4.11.jar;%APP_HOME%\lib\kotlin-stdlib-jdk7-1.9.0.jar;%APP_HOME%\lib\kotlin-reflect-1.8.10.jar;%APP_HOME%\lib\kotlin-stdlib-1.9.0.jar;%APP_HOME%\lib\logback-core-1.4.11.jar;%APP_HOME%\lib\slf4j-api-2.0.7.jar;%APP_HOME%\lib\kotlin-stdlib-common-1.9.0.jar;%APP_HOME%\lib\annotations-13.0.jar;%APP_HOME%\lib\netty-codec-http2-4.1.91.Final.jar;%APP_HOME%\lib\alpn-api-1.1.3.v20160715.jar;%APP_HOME%\lib\netty-transport-native-kqueue-4.1.91.Final.jar;%APP_HOME%\lib\netty-transport-native-epoll-4.1.91.Final.jar;%APP_HOME%\lib\config-1.4.2.jar;%APP_HOME%\lib\jansi-2.4.0.jar;%APP_HOME%\lib\netty-codec-http-4.1.91.Final.jar;%APP_HOME%\lib\netty-handler-4.1.91.Final.jar;%APP_HOME%\lib\netty-codec-4.1.91.Final.jar;%APP_HOME%\lib\netty-transport-classes-kqueue-4.1.91.Final.jar;%APP_HOME%\lib\netty-transport-classes-epoll-4.1.91.Final.jar;%APP_HOME%\lib\netty-transport-native-unix-common-4.1.91.Final.jar;%APP_HOME%\lib\netty-transport-4.1.91.Final.jar;%APP_HOME%\lib\netty-buffer-4.1.91.Final.jar;%APP_HOME%\lib\netty-resolver-4.1.91.Final.jar;%APP_HOME%\lib\netty-common-4.1.91.Final.jar
